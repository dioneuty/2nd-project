...
<script type="text/javascript">
	$(document).ready(function(e) {
		...
		var NO_profile =3;
		$(".profile,.ep_cont").css("display","none");
		
		$(".profile").each(function(idx){
			if(idx<4){
				$(this).css("display","inline-block");
		...
		$("#ep_morebutton").click(function() {
			NO_profile += 3;
			ep_the(NO_profile);
			if (NO_profile >= $(".profile").length) {
				$("#ep_morebutton").css("display", "none");
			}
		})
	})
	...
	<div class="container2 portfolio">
		<div class="row">
			...
			<div class="aside col-2 mcol-0">
				<img src="../imgs/education.png" alt="a" />
				<div class="menu">
					<p>교육 과정</p>
					<ul>
