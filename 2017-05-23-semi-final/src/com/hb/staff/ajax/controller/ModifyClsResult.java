...
@WebServlet("/staff/modifycls_result.hb")
public class ModifyClsResult extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(new Integer(Integer.parseInt(req.getParameter("tchr"))) != null) tchrN = new Integer(Integer.parseInt(req.getParameter("tchr")));
		if(new Integer(Integer.parseInt(req.getParameter("stnum"))) != null) stnum = Integer.parseInt(req.getParameter("stnum"));
		if(new Integer(Integer.parseInt(req.getParameter("modifyCls"))) != null) enum2 = Integer.parseInt(req.getParameter("modifyCls"));
		...
		try{
		result = pdao.modifyCls(ename, esub1, esub2, esub3, startdate, enddate, etotalday, tchrN, stnum, enum2);
		//DBcon.commit();
